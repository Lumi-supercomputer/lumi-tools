...
-- -----------------------------------------------------------------------------
--
-- Helper function: Convert a zulu time string to a more readable format
--
-- -----------------------------------------------------------------------------
...
do
    ...
    print( project .. ' ' .. (readablezulu( project_info['open_date'] ) or 'UNKOWN') .. ' / ' .. 
           (readablezulu( project_info['end_date'] ) or 'UNKOWN') .. ' / ' .. 
           (readablezulu( project_info['closed_date'] ) or 'UNKOWN') .. ' ' ..
           ': ' .. (project_info['title'] or 'UNKNOWN') )
